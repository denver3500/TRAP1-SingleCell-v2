...
# Save the dotplot
ggsave(paste0(picture_folder, "/schwann_markers/schwann_markers_annotated_dotplot.pdf"), 
...
ggsave(paste0(picture_folder, "/schwann_markers//schwann_markers_annotated_wide_UMAP.pdf"), 

...
gene_list <- c("PLA2G2A", "SLCO2B1", "CCL3L3", "S100A12", "KLRB1", "XCL2", "FCRLA", "IGJ", "CD1E", "LILRA4", "DARC", "FHL5", "PTHLH", "HJURP","MEGF10")
...
# Save the dotplot
ggsave(paste0(picture_folder, "/QC/markers_annotated_dotplot.pdf"), 
...
ggsave(paste0(picture_folder, "/QC/markers_annotated_wide_UMAP.pdf"), 
...
message("- schwann_markers_annotated_wide_UMAP.pdf (wide UMAP layout)")
message("- schwann_markers_annotated_dotplot.pdf (dotplot)")

...
gene_list <- c("S100B", "GAP43", "CD163", "PDGFRA")
...
# Save the dotplot
ggsave(paste0(picture_folder, "/schwann_markers/presentation_markers_annotated_dotplot.pdf"), 
       dot_plot, width = 12, height = 8)

# Wide version with wider cluster map
combined_plot_wide <- p_cluster + 
                     feature_plots[[1]] + feature_plots[[2]] + 
                     feature_plots[[3]] + feature_plots[[4]] +
...
ggsave(paste0(picture_folder, "/schwann_markers/presentation_markers_annotated_wide_UMAP.pdf"), 
       combined_plot_wide, width = 20, height = 12)
